...
class VAETrainer(Trainer):
    ...
    def __init__(self, cfg: TrainingConfig, device, model: nn.Module,
        ...
        assert cfg.in_shape in [(1, 28, 28), (3, 32, 32)]
        ...
        if self.gan_weight > 0.0:
            ...
            self.discriminator = Discriminator(in_channels=self.in_shape[0])
    ...
    def fit(self):
        ...
        summary(self.model, input_data=torch.ones(1, *self.in_shape, device=self.device))
