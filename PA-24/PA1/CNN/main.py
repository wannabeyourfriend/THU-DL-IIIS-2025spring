...
def run(model, train_set, valid_set, test_set, criterion, optimizer, scheduler, save_dir, task, num_epochs=20):
...
if __name__ == '__main__':
    ...
    run(model, train_dataset, valid_dataset, test_dataset, criterion, optimizer, scheduler, args.save_dir, task, num_epochs=num_epochs)
